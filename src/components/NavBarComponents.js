...
const NavBarComponents = () => {
  return (
    <>
      <div className="pl-20 pr-20 mt-5 flex justify-between items-center">
        <div className="flex item-center">
            ...
            <div className="flex flex-wrap justify-between ">
                ...
                <span className="ml-12 text-[#212529] font-light">Gift</span>
                <span className="ml-12 text-[#212529] font-light" >Order</span>
                <span className="ml-12 text-[#212529] font-light">Pay</span>
                <span className="ml-12 text-[#212529] font-light">Store</span>
            </div>
        </div>
        <div className="flex flex-wrap justify-between items-center w-3/12">
            <div className="relative">
            <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg"
            className="cursor-pointer w-5 h-5 text-gray-500 dark:text-grey-400 absolute top-2 left-2"
            >
